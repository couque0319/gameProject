...
(function (global) {
  ...
  const GAP   = 6000;  // 웨이브 간격(ms)       - EASY

  const START_H = 1000; // 첫 웨이브까지 대기(ms) - HARD(빠르게 시작)
  const GAP_H   = 4000; // 웨이브 간격(ms)       - HARD(조밀)
  ...
  STAGES.easy['01'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 1,  pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 1,  pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 8 },
      { t: START + GAP*2, count: 1,  pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*3, count: 1, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 1, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 10 },
    ],
    midBoss: [],
    boss: null
  };
  ...
  STAGES.easy['02'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 1,  pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 1,  pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 8 },
      { t: START + GAP*2, count: 1, pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE }, repeat: 2, every: 800 },
      { t: START + GAP*3, count: 1, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 1, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 10 },
    ],
    midBoss: [],
  ...
  STAGES.easy['03'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 2,  pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 2,  pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 8 },
      { t: START + GAP*2, count: 2, pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE }, repeat: 2, every: 1000 },
      { t: START + GAP*3, count: 2, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 2, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 10 },
    ],
  ...
  STAGES.easy['04'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 2, pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 2, pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 8 },
      { t: START + GAP*2, count: 2, pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE }, repeat: 3, every: 900 },
      { t: START + GAP*3, count: 3, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 3, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 10 },
    ],
    midBoss: [],
    boss: null
  };
  ...
  STAGES.easy['05'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 2, pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 2, pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 8 },
      { t: START + GAP*2, count: 3, pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE }, repeat: 2, every: 900 },
      { t: START + GAP*3, count: 3, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 3, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 10 },
    ],
    midBoss: [],
  ...
  STAGES.easy['06'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 2, pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 3, pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 9 },
  ...
  STAGES.easy['07'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 4, pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 4, pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 9 },
      { t: START + GAP*2, count: 4, pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE }, repeat: 2, every: 800 },
      { t: START + GAP*3, count: 4, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 4, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 12 },
    ],
    midBoss: [],
    boss: null
  };
  ...
  STAGES.easy['08'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 4, pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 4, pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 10 },
      { t: START + GAP*2, count: 4, pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE }, repeat: 3, every: 800 },
      { t: START + GAP*3, count: 3, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 2, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 12 },
    ],
    midBoss: [{ at: midAt(START, GAP, 2), key: 'midboss1' }],
    boss: null
  };
  ...
  STAGES.easy['09'] = {
    ...
    waves: [
      ...
      { t: START + GAP*2, count: 4, pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE }, repeat: 3, every: 800 },
      { t: START + GAP*3, count: 3, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 3, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 12 },
    ],
    midBoss: [],
  ...
  STAGES.easy['10'] = {
    ...
    waves: [
      { t: START + GAP*0, count: 2, pattern:'straight', form:'line',   enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*1, count: 3, pattern:'aim',      form:'random', enemy:{ ...ENEMY_BASE }, scatter: 10 },
      { t: START + GAP*2, count: 5, pattern:'spread3',  form:'line',   enemy:{ ...ENEMY_BASE }, repeat: 3, every: 700 },
      { t: START + GAP*3, count: 2, pattern:'aim',      form:'edges',  enemy:{ ...ENEMY_BASE } },
      { t: START + GAP*4, count: 1, pattern:'spread5',  form:'random', enemy:{ ...ENEMY_BASE }, scatter: 12 },
    ],
    midBoss: [],
    boss: { at: bossAt(START, GAP, 4), key: 'boss1' }
  };
